//
//  SCMediationCustomProxy.m
//  SCMediation
//
//  Created by ioser on 2018/12/29.
//  Copyright © 2018年 Sohu.com. All rights reserved.
//

#import "SCMediationCustomProxy.h"

@interface SCMediationCustomProxy ()

@property (weak, nonatomic) id target;

@end

@implementation SCMediationCustomProxy

+ (instancetype) proxyWithTarget:(id)target
{
    SCMediationCustomProxy *proxy = [[SCMediationCustomProxy alloc] init];
    proxy.target = target;
    return proxy;
}
